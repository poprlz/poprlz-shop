  ...
  <div class="container">
  <a class="brand" href="#">poprlz-shop</a>
 ...
 <ul class="nav pull-right">
		...
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
		     <li><a href="http://www.poprlz-shop.com/guide">新手向导</a></li>
		     <li><a href="http://www.poprlz-shop.com/developer">开发文档</a></li>
		     <li><a href="http://www.poprlz-shop.com/video">使用视频</a></li>
		     <li class="divider"></li>
		     <li><a href="http://www.poprlz-shop.com/support" >商业支持</a></li>
		     <li><a href="http://www.poprlz-shop.com/contact-us" >合作洽谈</a></li>
		     <li class="divider"></li>
		     <li><a href="http://www.poprlz-shop.com/about-us" >团队介绍</a></li>
		 	 <li><a href="http://bbs.poprlz-shop.com/" >支持论坛</a></li>
		 	 <li><a href="http://www.poprlz-shop.com/" >官方网站</a></li>
		  </ul>
		</li>
		<li class="dropdown">
