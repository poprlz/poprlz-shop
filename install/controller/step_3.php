...
class ControllerStep3 extends Controller {
	...
	public function index() {		
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$output  = '<?php' . "\n";
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_SHOP . '\');' . "\n";
			$output .= 'define(\'HTTP_IMAGE\', \'' . HTTP_SHOP . 'image/\');' . "\n";			
			$output .= 'define(\'HTTP_ADMIN\', \'' . HTTP_SHOP . 'admin/\');' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'' . HTTP_SHOP . '\');' . "\n";
			$output .= 'define(\'HTTPS_IMAGE\', \'' . HTTP_SHOP . 'image/\');' . "\n\n";
						
			$output .= '// DIR' . "\n";
			$output .= 'define(\'DIR_APPLICATION\', \'' . DIR_SHOP . 'catalog/\');' . "\n";
			$output .= 'define(\'DIR_SYSTEM\', \'' . DIR_SHOP. 'system/\');' . "\n";
			$output .= 'define(\'DIR_DATABASE\', \'' . DIR_SHOP . 'system/database/\');' . "\n";
			$output .= 'define(\'DIR_LANGUAGE\', \'' . DIR_SHOP . 'catalog/language/\');' . "\n";
			$output .= 'define(\'DIR_TEMPLATE\', \'' . DIR_SHOP . 'catalog/view/theme/\');' . "\n";
			$output .= 'define(\'DIR_CONFIG\', \'' . DIR_SHOP . 'system/config/\');' . "\n";
			$output .= 'define(\'DIR_IMAGE\', \'' . DIR_SHOP . 'image/\');' . "\n";
			$output .= 'define(\'DIR_CACHE\', \'' . DIR_SHOP . 'system/cache/\');' . "\n";
			$output .= 'define(\'DIR_DOWNLOAD\', \'' . DIR_SHOP . 'download/\');' . "\n";
			$output .= 'define(\'DIR_LOGS\', \'' . DIR_SHOP . 'system/logs/\');' . "\n\n";
			...
			$file = fopen(DIR_SHOP . 'config.php', 'w');
			...
			$output  = '<?php' . "\n";
			$output .= '// HTTP' . "\n";
			$output .= 'define(\'HTTP_SERVER\', \'' . HTTP_SHOP . 'admin/\');' . "\n";
			$output .= 'define(\'HTTP_CATALOG\', \'' . HTTP_SHOP . '\');' . "\n";
			$output .= 'define(\'HTTP_IMAGE\', \'' . HTTP_SHOP . 'image/\');' . "\n\n";

			$output .= '// HTTPS' . "\n";
			$output .= 'define(\'HTTPS_SERVER\', \'' . HTTP_SHOP . 'admin/\');' . "\n";
			$output .= 'define(\'HTTPS_IMAGE\', \'' . HTTP_SHOP . 'image/\');' . "\n\n";

			$output .= '// DIR' . "\n";
		
			$output .= 'define(\'DIR_APPLICATION\', \'' . DIR_SHOP . 'admin/\');' . "\n";
			$output .= 'define(\'DIR_SYSTEM\', \'' . DIR_SHOP . 'system/\');' . "\n";
			$output .= 'define(\'DIR_DATABASE\', \'' . DIR_SHOP . 'system/database/\');' . "\n";
			$output .= 'define(\'DIR_LANGUAGE\', \'' . DIR_SHOP . 'admin/language/\');' . "\n";
			$output .= 'define(\'DIR_TEMPLATE\', \'' . DIR_SHOP . 'admin/view/template/\');' . "\n";
			$output .= 'define(\'DIR_CONFIG\', \'' . DIR_SHOP . 'system/config/\');' . "\n";
			$output .= 'define(\'DIR_IMAGE\', \'' . DIR_SHOP . 'image/\');' . "\n";
			$output .= 'define(\'DIR_CACHE\', \'' . DIR_SHOP . 'system/cache/\');' . "\n";
			$output .= 'define(\'DIR_DOWNLOAD\', \'' . DIR_SHOP . 'download/\');' . "\n";
			$output .= 'define(\'DIR_LOGS\', \'' . DIR_SHOP . 'system/logs/\');' . "\n";
			$output .= 'define(\'DIR_CATALOG\', \'' . DIR_SHOP . 'catalog/\');' . "\n\n";
			...
			$file = fopen(DIR_SHOP . 'admin/config.php', 'w');
	...
	private function validate() {
		...
		if (!is_writable(DIR_SHOP . 'config.php')) {
			$this->error['warning'] = '错误: config.php 没有写入权限: ' . DIR_SHOP . 'config.php!';
		}
	
		if (!is_writable(DIR_SHOP . 'admin/config.php')) {
			$this->error['warning'] = '错误: config.php 没有写入权限: ' . DIR_SHOP . 'admin/config.php!';
		}	
